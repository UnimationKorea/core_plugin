...
<body>
  ...
  `));I.onError((e,t)=>(console.error("🚨 Application error:",e),t.json({success:!1,error:"Internal server error",message:"An unexpected error occurred"},500)));I.notFound(e=>e.json({success:!1,error:"Not found",message:`Endpoint ${e.req.url} not found`},404));console.log("🚀 Enhanced Educational Platform API v2.0 initialized");console.log("📋 Features: Modular Sandbox, Guardrail System, Dynamic Templates");const Be=new vt,Qt=Object.assign({"/src/index.tsx":I});let yt=!1;for(const[,e]of Object.entries(Qt))e&&(Be.route("/",e),Be.notFound(e.notFoundHandler),yt=!0);if(!yt)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{Be as default};
