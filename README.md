...
### 새 액티비티 템플릿 개발 가이드
1. `BaseActivityTemplate` 클래스 상속
2. 매니페스트 정의 (ID, 스키마, 기능)
3. `mount`, `unmount`, `getResult` 메서드 구현
4. 접근성 및 반응형 지원
5. 템플릿 레지스트리에 등록
